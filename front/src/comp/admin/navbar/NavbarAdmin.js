...
const NavDropAddData = ({ucid}) => {
    ...
    return (
        ...
        {(ucid === 1 || 2) && <NavLink className="adminlvl2" exact to="#" activeClassName="notactive" id="showmemore" onClick={e => setShowModData(!showModData)}>Add Pokémon data {showModData ? <i className="fa fa-caret-up"></i> : <i className="fa fa-caret-down"></i>}</NavLink>}
...
const NavbarAdmin = ({ucid}) => {
    ...
    return (
        ...
        {(ucid === 1 || 2) && <NavLink className="adminlvl1" exact to="#" activeClassName="notactive" id="showmemore" onClick={e => setShowDataManager(!showDataManager)}>Manage Pokémon Data {showDataManager ? <i className="fa fa-caret-up"></i> : <i className="fa fa-caret-down"></i>}</NavLink>}
