...
const NavbarAdmin = ({ucid}) => {
    ...
    return (
        ...
        {ucid === 1 && <NavLink exact to="#" activeClassName="notactive" id="showmemore" onClick={e => setShowPublish(!showPublish)}>News &#38; Events {showPublish ? <i className="fa fa-caret-up"></i> : <i className="fa fa-caret-down"></i>}</NavLink>}
